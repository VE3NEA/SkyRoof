...
The following libraries, images and other resources were used in the SkyRoof project:
...
- [Satellite icons created by Dighital - Flaticon](https://www.flaticon.com/free-icons/satellite)
- [SVG Repo](https://www.svgrepo.com)
- [Lunapic image editor](https://www1.lunapic.com/editor/)
